...
<template>
  ...
  >
    <div
      v-if="slots.media"
      class="list_media py-l px-none pr-xl"
      :class="{
    ...
    <div
      class="list_content py-l px-none grow"
      :class="{
    ...
    <div
      v-if="slots.text"
      class="list_text py-l px-none pl-xl text-primary-900 text-right font-bold"
      :class="{
        'border-b border-neutral-200': divider,
      }"
    ...
    <div
      v-if="slots.controls"
      class="list_controls py-l px-none pl-xl text-right"
      :class="{
        'border-b border-neutral-200': divider,
      }"
